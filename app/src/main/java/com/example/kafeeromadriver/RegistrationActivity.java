...
import com.example.kafeeromadriver.Model.User;
                    ...
                    table_user.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.child(mPhoneView.getText().toString()).exists()){
                                mDialog.dismiss();
                                Toast.makeText(RegistrationActivity.this, "Phone number already registered in database", Toast.LENGTH_SHORT).show();
                            }else{
                                mDialog.dismiss();
                                User user = new User(mUserView.getText().toString(), mPasswordView.getText().toString());
                                table_user.child(mPhoneView.getText().toString()).setValue(user);
